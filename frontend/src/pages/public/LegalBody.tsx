...
export function LegalBody({ children }: { children: ReactNode }) {
  return (
    <div
      className="
        mt-8 max-w-[68ch] text-[1.0625rem] leading-relaxed text-asphalt-700
        [&_h2]:mb-2 [&_h2]:mt-8 [&_h2]:text-xl [&_h2]:font-extrabold [&_h2]:tracking-tight [&_h2]:text-asphalt-950
        [&_p]:mb-4
        [&_ul]:mb-4 [&_ul]:space-y-2 [&_ul]:pl-5
        [&_li]:list-disc [&_li]:marker:text-midnight-800
        [&_strong]:text-asphalt-950
