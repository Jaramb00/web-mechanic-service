  ...
  return (
    <>
      ...
      {isLoading ? (
        ...
        <ul className="space-y-px overflow-hidden rounded-sign border-2 border-ink-950">
          {data?.map((entry) => {
            ...
            return (
              ...
              >
                <span className="w-32 shrink-0 font-bold capitalize text-ink-950">
                  {weekdayName(entry.dayOfWeek)}
                </span>

                <label className="flex items-center gap-2 text-[0.9375rem] font-semibold text-ink-900">
                  <input
                    type="checkbox"
                    className="h-5 w-5"
                ...
                <span className="flex items-center gap-2">
                  ...
                  <input
                    ...
                    className="min-h-11 rounded-plate border-2 border-ink-300 bg-white px-2 tabular-nums disabled:bg-ink-50 disabled:text-ink-300"
                  />
